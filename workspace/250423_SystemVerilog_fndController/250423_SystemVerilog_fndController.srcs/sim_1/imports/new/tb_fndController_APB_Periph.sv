...
class scoreboard;
    ...
    logic [7:0] refFndFont[0:15] = '{8'hc0, 8'hf9, 8'ha4, 8'hb0, 8'h99, 8'h92, 8'h82, 
    8'hf8, 8'h80, 8'h90, 8'h88, 8'h83, 8'hc6, 8'ha1, 8'h86, 8'h8e};
    ...
    task run();
        forever begin
            ...
            if (fnd_tr.PWRITE) begin // write mode
                ...
                if(refFndFont[refFndReg[2]] == fnd_tr.fndFont[7:0]) begin //Pass!
