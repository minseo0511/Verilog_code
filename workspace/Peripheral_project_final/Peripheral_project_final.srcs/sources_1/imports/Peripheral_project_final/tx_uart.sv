...
module UART_TX_Periph (
    ...
    assign FSR = {tx_busy, tx_done, full, empty};
...
module APB_SlaveIntf_FIFO (
    ...
    assign slv_reg0[3:0] = FSR; // FIFO State Register -> 0: empty, 1 : full, 2: tx complete, 3: tx busy
...
module fifo_control_unit_tx (
    ...
    logic [2:0] wr_ptr_reg, wr_ptr_next, rd_ptr_reg, rd_ptr_next;
