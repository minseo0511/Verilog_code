...
module top_stopwatch (
    ...
    wire uart_run, uart_clear, uart_hour, uart_min, uart_sec;
    ...
    wacth_dp U_watch_dp1 (
        .clk(clk),
        .reset(reset),
        .cu_sec_up(cu_sec | uart_sec),
        .cu_min_up(cu_min | uart_min),
        .cu_hour_up(cu_hour | uart_hour),
        .msec(clk_msec),
        .sec(clk_sec),
        .min(clk_min),
        .hour(clk_hour),
