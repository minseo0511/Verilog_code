...
module dht11_peri (
    ...
    logic [ 3:0] w_digit_1;
    logic [ 7:0] w_ASCII_1000;
    logic [ 7:0] w_ASCII_100;
    logic [ 7:0] w_ASCII_10;
    logic [ 7:0] w_ASCII_1;

    assign dlr = {checksum_led, mode_state_led};
    // assign dud = {w_ASCII_1000, w_ASCII_100, w_ASCII_10, w_ASCII_1};
    assign dud = mode_data;
    tick_1us #(
        .TICK_COUNT(100),
        .BIT_WIDTH (7)
    ) U_Tick_1us (
    ...
    // decimaltoASCII U_digit_1000(
    //     .data_digit(w_digit_1000),
    //     .clk(PCLK),
    //     .reset(PRESET),
    //     .data_ASCII(w_ASCII_1000)
    // );

    // decimaltoASCII U_digit_100(
    //     .data_digit(w_digit_100),
    //     .clk(PCLK),
    //     .reset(PRESET),
    //     .data_ASCII(w_ASCII_100)
    // );
    // decimaltoASCII U_digit_10(
    //     .data_digit(w_digit_10),
    //     .clk(PCLK),
    //     .reset(PRESET),
    //     .data_ASCII(w_ASCII_10)
    // );
    // decimaltoASCII U_digit_1(
    //     .data_digit(w_digit_1),
    //     .clk(PCLK),
    //     .reset(PRESET),
    //     .data_ASCII(w_ASCII_1)
    // );
...
module APB_SlaveIntf_DHT11 (
    ...
    input  logic [31:0] dud       // sensor to uart ASCII data(temp or hum)
);
