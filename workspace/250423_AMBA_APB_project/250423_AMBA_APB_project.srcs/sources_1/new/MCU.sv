...
module MCU (
    ...
    UltraSensor_Periph U_UltraSensor_Periph(
        .*,
        .PSEL(PSEL_UltraSensor),
        .PRDATA(PRDATA_UltraSensor),
        .PREADY(PREADY_UltraSensor),
        .btn_trig(btn_trig),
        .echo(echo),
        .trigger(trigger)
    );
